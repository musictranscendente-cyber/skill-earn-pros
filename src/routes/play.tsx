...
// Lista grande de propósito (e com "jeito de gente" — apelido comum + número/ponto/
// underline, em vez do padrão "AdjetivoSubstantivo" repetitivo tipo "ShadowByte") pra
// escolha aleatória em beginSearch() abaixo não repetir o mesmo adversário toda hora.
const OPPONENTS = [
  { name: "kaio_gg", emoji: "🎮" },
  { name: "mari.silva", emoji: "🌸" },
  { name: "theo_ttv", emoji: "📺" },
  { name: "duda_br", emoji: "🔥" },
  { name: "rafa_x", emoji: "⚡️" },
  { name: "bia.games", emoji: "🎲" },
  { name: "gabs07", emoji: "🚀" },
  { name: "enzo_pro", emoji: "🏆" },
  { name: "lara.vibes", emoji: "🌈" },
  { name: "pedro_h", emoji: "🦊" },
  { name: "analuiza", emoji: "🌙" },
  { name: "vitin22", emoji: "⭐️" },
  { name: "sofia.gg", emoji: "💎" },
  { name: "miguelzin", emoji: "🐺" },
  { name: "julia_br", emoji: "🍀" },
  { name: "bernardo_x", emoji: "🛡️" },
  { name: "helena99", emoji: "🦋" },
  { name: "davi_gamer", emoji: "🎯" },
  { name: "valentina.s", emoji: "🌺" },
  { name: "arthur_ttv", emoji: "📸" },
  { name: "manu_br", emoji: "🎪" },
  { name: "joaovictor", emoji: "🐍" },
  { name: "alice.gg", emoji: "🎀" },
  { name: "gustavo07", emoji: "🦅" },
  { name: "laura_m", emoji: "🌟" },
  { name: "bryan_x", emoji: "🔱" },
  { name: "isadora99", emoji: "🌻" },
  { name: "felipe_br", emoji: "🐯" },
  { name: "clara.gg", emoji: "🎨" },
  { name: "matheus_ttv", emoji: "🎬" },
  { name: "yasmin22", emoji: "💫" },
  { name: "caiosilva", emoji: "🐉" },
  { name: "livia_br", emoji: "🦁" },
  { name: "nicolas07", emoji: "⚔️" },
  { name: "amanda.gg", emoji: "🌼" },
  { name: "otavio_x", emoji: "🦂" },
  { name: "carol99", emoji: "🎈" },
  { name: "leo_gamer", emoji: "🐲" },
  { name: "nathalia_b", emoji: "🌷" },
  { name: "pietro.x", emoji: "🚁" },
  { name: "beatriz22", emoji: "🎊" },
  { name: "samuel_br", emoji: "🏹" },
  { name: "luiza.gg", emoji: "🦄" },
  { name: "thiago07", emoji: "🌊" },
  { name: "camila_x", emoji: "🎭" },
  { name: "rodrigo99", emoji: "🗡️" },
];
